...
GTAT_Urban::GTAT_Urban(int &systemTTI, Configure& systemConfig, eNB* &systemeNBAry, Road* &systemRoadAry, RSU* &systemRSUAry, VeUE* &systemVeUEAry) :
...
void GTAT_Urban::initialize() {
	...
	for (int RSUIdx = 0; RSUIdx != m_Config.RSUNum; RSUIdx++)
	{
		...
		m_RSUAry[RSUIdx].initializeGTAT_Urban(RSUConfigure);
	}
	...
	for (int RoadIdx = 0; RoadIdx != m_Config.UrbanRoadNum; RoadIdx++)
	{
		...
		for (int uprIdx = 0; uprIdx != m_Config.pupr[RoadIdx]; uprIdx++)
		{
			...
			m_VeUEAry[ueidx++].initializeGTAT_Urban(ueConfigure);
...
void GTAT_Urban::freshLoc() {
	for (int UserIdx = 0; UserIdx != m_Config.VeUENum; UserIdx++)
	{
		...
		int temp;
		switch (m_VeUEAry[UserIdx].m_GTAT_Urban->m_LocationId)
		{
		case 191:
			m_VeUEAry[UserIdx].m_GTAT_Urban->m_LocationId = 0;
			break;
		case 0:
			temp = rand() % 4;
			if (temp == 0)//turn left
			{
				RoadChangeFlag = true;
				m_VeUEAry[UserIdx].m_GTAT_Urban->m_RoadId = gc_WrapAroundRoad[m_VeUEAry[UserIdx].m_GTAT_Urban->m_RoadId][4];
				m_VeUEAry[UserIdx].m_GTAT_Urban->m_LocationId = 96;
				m_VeUEAry[UserIdx].m_GTAT_Urban->m_VAngle = -90;
			}
			else
				if (temp == 2)//turn right
				{
					m_VeUEAry[UserIdx].m_GTAT_Urban->m_LocationId = m_VeUEAry[UserIdx].m_GTAT_Urban->m_LocationId + 1;
					m_VeUEAry[UserIdx].m_GTAT_Urban->m_VAngle = 90;
				}
				else//go straight，不改变方向
				{
					RoadChangeFlag = true;
					m_VeUEAry[UserIdx].m_GTAT_Urban->m_RoadId = gc_WrapAroundRoad[m_VeUEAry[UserIdx].m_GTAT_Urban->m_RoadId][5];
					m_VeUEAry[UserIdx].m_GTAT_Urban->m_LocationId = 157;
				}
			break;
		case 61:
			temp = rand() % 4;
			...
			{
				RoadChangeFlag = true;
				m_VeUEAry[UserIdx].m_GTAT_Urban->m_RoadId = gc_WrapAroundRoad[m_VeUEAry[UserIdx].m_GTAT_Urban->m_RoadId][6];
				m_VeUEAry[UserIdx].m_GTAT_Urban->m_LocationId = 157;
				m_VeUEAry[UserIdx].m_GTAT_Urban->m_VAngle = -180;
			}
			else
				if (temp == 2)
				{
					m_VeUEAry[UserIdx].m_GTAT_Urban->m_LocationId = m_VeUEAry[UserIdx].m_GTAT_Urban->m_LocationId + 1;
					m_VeUEAry[UserIdx].m_GTAT_Urban->m_VAngle = 0;
				}
				else
				{
					RoadChangeFlag = true;
					m_VeUEAry[UserIdx].m_GTAT_Urban->m_RoadId = gc_WrapAroundRoad[m_VeUEAry[UserIdx].m_GTAT_Urban->m_RoadId][7];
					m_VeUEAry[UserIdx].m_GTAT_Urban->m_LocationId = 0;
					m_VeUEAry[UserIdx].m_GTAT_Urban->m_VAngle = 270;
				}
			break;
		case 96:
			temp = rand() % 4;
			...
			{
				RoadChangeFlag = true;
				m_VeUEAry[UserIdx].m_GTAT_Urban->m_RoadId = gc_WrapAroundRoad[m_VeUEAry[UserIdx].m_GTAT_Urban->m_RoadId][8];
				m_VeUEAry[UserIdx].m_GTAT_Urban->m_LocationId = 0;
				m_VeUEAry[UserIdx].m_GTAT_Urban->m_VAngle = 90;
			}
			else
				...
				{
					RoadChangeFlag = true;
					m_VeUEAry[UserIdx].m_GTAT_Urban->m_RoadId = gc_WrapAroundRoad[m_VeUEAry[UserIdx].m_GTAT_Urban->m_RoadId][1];
					m_VeUEAry[UserIdx].m_GTAT_Urban->m_LocationId = 61;
				}
			break;
		case 157:
			temp = rand() % 4;
			...
			{
				RoadChangeFlag = true;
				m_VeUEAry[UserIdx].m_GTAT_Urban->m_RoadId = gc_WrapAroundRoad[m_VeUEAry[UserIdx].m_GTAT_Urban->m_RoadId][2];
				m_VeUEAry[UserIdx].m_GTAT_Urban->m_LocationId = 61;
				m_VeUEAry[UserIdx].m_GTAT_Urban->m_VAngle = 0;
			}
			else
				...
				{
					RoadChangeFlag = true;
					m_VeUEAry[UserIdx].m_GTAT_Urban->m_RoadId = gc_WrapAroundRoad[m_VeUEAry[UserIdx].m_GTAT_Urban->m_RoadId][3];
					m_VeUEAry[UserIdx].m_GTAT_Urban->m_LocationId = 96;
				}
			break;
		default:
		...
		m_VeUEAry[UserIdx].m_GTAT_Urban->m_X = m_Config.pueTopo[m_VeUEAry[UserIdx].m_GTAT_Urban->m_LocationId * 2 + 0];
		m_VeUEAry[UserIdx].m_GTAT_Urban->m_Y = m_Config.pueTopo[m_VeUEAry[UserIdx].m_GTAT_Urban->m_LocationId * 2 + 1];
		m_VeUEAry[UserIdx].m_GTAT_Urban->m_AbsX = m_RoadAry[m_VeUEAry[UserIdx].m_GTAT_Urban->m_RoadId].m_GTAT_Urban->m_AbsX + m_VeUEAry[UserIdx].m_GTAT_Urban->m_X;
		m_VeUEAry[UserIdx].m_GTAT_Urban->m_AbsY = m_RoadAry[m_VeUEAry[UserIdx].m_GTAT_Urban->m_RoadId].m_GTAT_Urban->m_AbsY + m_VeUEAry[UserIdx].m_GTAT_Urban->m_Y;
	...
	for (int UserIdx1 = 0; UserIdx1 != m_Config.VeUENum; UserIdx1++)
	{
		...
		if (m_VeUEAry[UserIdx1].m_GTAT_Urban->m_LocationId <= 30) {
			RSUIdx = gc_RSUInRoad[m_VeUEAry[UserIdx1].m_GTAT_Urban->m_RoadId][3];
			ClusterID = 0;
		}
			...
			RSUIdx = gc_RSUInRoad[m_VeUEAry[UserIdx1].m_GTAT_Urban->m_RoadId][0];
			ClusterID = 3;
		}
			...
			RSUIdx = gc_RSUInRoad[m_VeUEAry[UserIdx1].m_GTAT_Urban->m_RoadId][1];
			ClusterID = 5;
		}
			...
			RSUIdx = gc_RSUInRoad[m_VeUEAry[UserIdx1].m_GTAT_Urban->m_RoadId][2];
			ClusterID = 7;
		}
		else {
			RSUIdx = gc_RSUInRoad[m_VeUEAry[UserIdx1].m_GTAT_Urban->m_RoadId][2];
		...
		case 2:
			...
			break;
		case 3:
			RSUIdx = c_RSUInRoad[m_VeUEAry[UserIdx1].m_GTAT_Urban->m_RoadId][9];
			ClusterID = 2;
			break;
		case 4:
			RSUIdx = c_RSUInRoad[m_VeUEAry[UserIdx1].m_GTAT_Urban->m_RoadId][9];
		...
		case 8:
		case 9:
			if (m_VeUEAry[UserIdx1].m_GTAT_Urban->m_LocationId<87)
			{
				RSUIdx = c_RSUInRoad[m_VeUEAry[UserIdx1].m_GTAT_Urban->m_RoadId][1];
				if ((m_VeUEAry[UserIdx1].m_GTAT_Urban->m_LocationId<78))  ClusterID = 3;
				else ClusterID = 2;
			}
			else
			{
				RSUIdx = c_RSUInRoad[m_VeUEAry[UserIdx1].m_GTAT_Urban->m_RoadId][2];
				if ((m_VeUEAry[UserIdx1].m_GTAT_Urban->m_LocationId<96))  ClusterID = 6;
				else ClusterID = 5;
			}
			break;
		case 10:
		case 11:
		case 12:
			if (m_VeUEAry[UserIdx1].m_GTAT_Urban->m_LocationId<106)
			{
				RSUIdx = c_RSUInRoad[m_VeUEAry[UserIdx1].m_GTAT_Urban->m_RoadId][2];
				ClusterID = 5;
			}
			else
			{
				...
				if ((m_VeUEAry[UserIdx1].m_GTAT_Urban->m_LocationId<116))  ClusterID = 0;
				else ClusterID = 3;
			}
			break;
		case 13:
			if (m_VeUEAry[UserIdx1].m_GTAT_Urban->m_LocationId<126)
			{
				RSUIdx = c_RSUInRoad[m_VeUEAry[UserIdx1].m_GTAT_Urban->m_RoadId][3];
				ClusterID = 3;
			}
			...
			{
				RSUIdx = c_RSUInRoad[m_VeUEAry[UserIdx1].m_GTAT_Urban->m_RoadId][4];
				if ((m_VeUEAry[UserIdx1].m_GTAT_Urban->m_LocationId<136))  ClusterID = 0;
				else ClusterID = 3;
			}
			break;
		case 14:
			if (m_VeUEAry[UserIdx1].m_GTAT_Urban->m_LocationId<146)
			{
				RSUIdx = c_RSUInRoad[m_VeUEAry[UserIdx1].m_GTAT_Urban->m_RoadId][4];
				ClusterID = 3;
			}
			...
			{
				RSUIdx = c_RSUInRoad[m_VeUEAry[UserIdx1].m_GTAT_Urban->m_RoadId][5];
				ClusterID = 0;
			}
			break;
		case 15:
		case 16:
		case 17:
			if (m_VeUEAry[UserIdx1].m_GTAT_Urban->m_LocationId<165)
			{
				RSUIdx = c_RSUInRoad[m_VeUEAry[UserIdx1].m_GTAT_Urban->m_RoadId][5];
				if ((m_VeUEAry[UserIdx1].m_GTAT_Urban->m_LocationId<157))  ClusterID = 0;
				else ClusterID = 7;
			}
			else
			{
				RSUIdx = c_RSUInRoad[m_VeUEAry[UserIdx1].m_GTAT_Urban->m_RoadId][6];
				if ((m_VeUEAry[UserIdx1].m_GTAT_Urban->m_LocationId<174))  ClusterID = 1;
				else ClusterID = 0;
			}
			break;
		case 18:
		case 19:
			if (m_VeUEAry[UserIdx1].m_GTAT_Urban->m_LocationId<183)
			{
				RSUIdx = c_RSUInRoad[m_VeUEAry[UserIdx1].m_GTAT_Urban->m_RoadId][6];
				ClusterID = 0;
			}
			...
			{
				RSUIdx = c_RSUInRoad[m_VeUEAry[UserIdx1].m_GTAT_Urban->m_RoadId][7];
				ClusterID = 2;
			}
			break;
		case 0:
		...
		if (location.bManhattan == true)  //计算location distance
		{
			...
			angle = atan2(m_VeUEAry[UserIdx1].m_GTAT_Urban->m_AbsY - m_RSUAry[RSUIdx].m_GTAT_Urban->m_AbsY, m_VeUEAry[UserIdx1].m_GTAT_Urban->m_AbsX - m_RSUAry[RSUIdx].m_GTAT_Urban->m_AbsX) / gc_Degree2PI;
		...
		m_VeUEAry[UserIdx1].m_GTAT_Urban->m_IMTA[RSUIdx].build(&t_Pl, gc_FC, location, antenna, m_VeUEAry[UserIdx1].m_GTAT_Urban->m_V, m_VeUEAry[UserIdx1].m_GTAT_Urban->m_VAngle);//计算了结果代入信道模型计算UE之间信道系数
		bool *flag = new bool();
			...
			for (int interferenceVeUEId: lst){
				...
				if (location.bManhattan == true)  //计算location distance
				{
					if (abs(m_VeUEAry[interferenceVeUEId].m_GTAT_Urban->m_AbsX - m_RSUAry[RSUIdx].m_GTAT_Urban->m_AbsX) <= 10.5 || abs(m_VeUEAry[interferenceVeUEId].m_GTAT_Urban->m_AbsY - m_RSUAry[RSUIdx].m_GTAT_Urban->m_AbsY) <= 10.5)
					{
						...
						angle = atan2(m_VeUEAry[interferenceVeUEId].m_GTAT_Urban->m_AbsY - m_RSUAry[RSUIdx].m_GTAT_Urban->m_AbsY, m_VeUEAry[interferenceVeUEId].m_GTAT_Urban->m_AbsX - m_RSUAry[RSUIdx].m_GTAT_Urban->m_AbsX) / gc_Degree2PI;
					}
					else
					{
						location.eType = Nlos;
				...
				double t_Pl = 0;
				m_VeUEAry[interferenceVeUEId].m_GTAT_Urban->m_IMTA[RSUIdx].build(&t_Pl, gc_FC, location, antenna, m_VeUEAry[interferenceVeUEId].m_GTAT_Urban->m_V, m_VeUEAry[interferenceVeUEId].m_GTAT_Urban->m_VAngle);//计算了结果代入信道模型计算UE之间信道系数
				bool *flag = new bool();
