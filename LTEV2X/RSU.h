	...
	struct RRM {
		...
		* ==========================================*/
		...
		public:
			...
			ScheduleInfo() {}
			ScheduleInfo(int t_EventId, int t_VeUEId, int t_RSUId, int t_PatternIdx) {
...
inline
void RSU::RRM_ICC_DRA::pushToSwitchEventIdList(int t_EventId, std::list<int>& t_SwitchVeUEIdList) {
	t_SwitchVeUEIdList.push_back(t_EventId);
}
