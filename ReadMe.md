## version_2016_12_11(将RRM_TDM_DRA的配置参数写入配置文档)

## version_2016_12_7(将分簇策略改回方向角分配，总簇数为4；拥塞区域策略依旧为5个区域；修改了高速公路场景下初始撒点算法，使得撒点结果更接近与空间泊松分布)

## version_2016_12_5(修改拥塞等级)

## version_2016_12_4(结构调整2)

## version_2016_12_4(Debug)

## version_2016_12_4(调整结构)

## version_2016_12_4(车辆的拥塞等级分配以簇为主)
...
## version_2016_11_30(增加配置文件)
* 增加高速场景配置文件
* 增加TMC模块配置文件

## version_2016_11_29(城镇场景部分参数写入配置文件)

## version_2016_11_28(改一下m文件)

## version_2016_11_26(修改配置文件后缀)
* 将配置文件改为.xml后缀

## version_2016_11_26(微调)

## version_2016_11_26(更改了头文件的包含依赖关系)

## version_2016_11_26(删除所有全局变量)

## version_2016_11_25(删掉了FILE)

## version_2016_11_23(修复了莫名bug)

## version_2016_11_23(Debug)

## version_2016_11_23(增加日志开关)


## version_2016_11_23(设置了Nlos场景，使得RSU下所属车辆基本都与RSU在同一横向或纵向道路上；输出了所有VeUE的信息数据，用于matlab画出拓扑图)
...
## version_2016_11_23(大改动3)
* 将系统类与各个单元建立关联，而不是传入系统类的资源引用或指针
* 解决了两个类相互包含的头文件布局方式


## version_2016_11_23(大改动)
* 修改了eNB Road的层次结构

## version_2016_11_22(大改动)
* 修改了RSU的层次结构


## version_2016_11_22(微调)
...
## version_2016_11_21(再次修改matlab作图)
* ...
...
## version_2016_11_20(路径bug)

## version_2016_11_20(增加冲突退避机制)
* 目前只写了ICC_DRA模式的冲突退避

## version_2016_11_20(修改Event)
* 删除Message类
* 封装Event类，全部域设为私有，禁止直接访问，Event对象的状态完全由其方法来控制

## version_2016_11_19(加注释2)
...
## version_2016_11_18(删除RA分支)

## version_2016_11_18(整合了Linux平台)
* 尚未完成


## version_2016_11_18(修改了车辆对于RSU的选择方式，由地理位置划分到接受功率划分；修改了分簇的依据由地理位置划分到方向角划分)

## version_2016_11_15(加点注释)

## version_2016_11_14(将SINR计算方式写入配置文件)


## version_2016_11_14(加点注释)


## version_2016_11_14(无聊随便改改)
